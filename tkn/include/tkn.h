...
extern void *tknCreateRenderPassBindingGroupLayout(uint32_t shaderPathCount, const char **shaderPaths);
extern void tknDestroyRenderPassBindingGroupLayout(void *pTknRenderPassBindingGroupLayout);
