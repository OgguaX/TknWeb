...
extern void *tknCreateImageView(void *pTknGfxContext, int baseLayer, int layerCount, int aspectFlags, int baseMipLevel, int mipLevelCount, int dimension, int format, void *pTknImage);
